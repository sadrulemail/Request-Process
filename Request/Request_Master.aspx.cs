...
public partial class Request_Master : System.Web.UI.Page
{
    ...
    {
        Title = "Service Request Entry Form - Trust Bank";
    ...
    protected void cmdNextStep_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand(Query, conn))
            {
                ...
                cmd.Parameters.Add("@ReqBrowser", System.Data.SqlDbType.VarChar).Value = "";
        ...
        Response.Redirect(string.Format("Request_iBanking.aspx?email={0}&keycode={1}&reqid={2}", Request.QueryString["email"], Request.QueryString["keycode"], ReqID), true);
    }
}