<%@ Page Title="" Language="C#" MasterPageFile="~/TrustBank.master" AutoEventWireup="true"
    CodeFile="Request_Master.aspx.cs" Inherits="Request_Master" Culture="en-NZ" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 has-feedback">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtOTP" runat="server" ControlToValidate="txtOTP"
                                        ErrorMessage="*" SetFocusOnError="True" CssClass="form-control-feedback"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <EditItemTemplate>
                                <div class="row">
                                    <label class="col-sm-2 control-label">
                                        Full Name</label>
                                    <div class="col-sm-2">
                                        <asp:TextBox runat="server" ID="txtTitle" Text='<%# Bind("Title") %>' CssClass="form-control"
                                            MaxLength="50" placeholder="Title"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                        <asp:TextBox runat="server" AutoCompleteType="FirstName" CssClass="form-control"
                                            ID="txtFirstName" Text='<%# Bind("FirstName") %>' MaxLength="50" placeholder="First Name"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                        <asp:TextBox runat="server" ID="txtMiddleName" CssClass="form-control" Text='<%# Bind("MiddleName") %>'
                                    ...
                                    <div class="col-sm-2">
                                        <asp:TextBox runat="server" ID="txtLastName" Text='<%# Bind("LastName") %>' MaxLength="50"
                                            CssClass="form-control" placeholder="Last Name" AutoCompleteType="LastName"></asp:TextBox>
                                    </div>
                                </div>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mobile No." ShowHeader="false">
                            ...
                            <EditItemTemplate>
                                <div class="row">
                                    <label class="col-sm-2 control-label">
                                        Mobile Number</label>
                                    <div class="col-sm-3 has-feedback has-success has-error">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 has-feedback">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDOB" runat="server" ControlToValidate="txtDOB"
                                            ErrorMessage="*" SetFocusOnError="True" Display="Dynamic" class="form-control-feedback"></asp:RequiredFieldValidator>
                                    </div>
                                    <label class="col-sm-1 control-label">
                                        Sex</label>
                                    <div class="col-sm-2">
                            ...
                            <EditItemTemplate>
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 has-feedback">
                                        <asp:TextBox ID="txtOccupation" CssClass="form-control" MaxLength="255" runat="server"
                                            Text='<%# Bind("Occupation") %>'></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtOccupation" runat="server"
                                            ControlToValidate="txtOccupation" ErrorMessage="*" SetFocusOnError="True" Display="Dynamic"
                            ...
                            <EditItemTemplate>
                                <div class="row">
                                    <label class="col-sm-2 control-label">
                                        Identity</label>
                                    <div class="col-sm-3 has-feedback">
                                        <asp:DropDownList ID="dboDivisionID" runat="server" CssClass="form-control" AppendDataBoundItems="true"
                                            AutoPostBack="True" DataSourceID="SqlDataSourceID" DataTextField="IDTypeName"
                                            DataValueField="IdTypeID" SelectedValue='<%# Bind("IdType1") %>'>
                                            <asp:ListItem Text="Select ID Type" Value=""></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatordboDivisionID" runat="server"
                                            ControlToValidate="dboDivisionID" ErrorMessage="*" SetFocusOnError="True" CssClass="form-control-feedback"></asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="col-sm-4 has-feedback">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtIdNumber1" runat="server"
                                            ControlToValidate="txtIdNumber1" ErrorMessage="*" CssClass="form-control-feedback"
                            ...
                            <EditItemTemplate>
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 has-feedback">
                                        <asp:SqlDataSource ID="SqlDataSourceDropDownListCountry" runat="server" ConnectionString="<%$ ConnectionStrings:Request_ProcessConnectionString %>"
                                            SelectCommand="SELECT * FROM [dbo].[v_COUNTRY_CODES] ORDER BY Country_Name">
                                        </asp:SqlDataSource>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDropDownListCountry" runat="server"
                                            CssClass="form-control-feedback" ControlToValidate="DropDownListCountry" ErrorMessage="*"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <asp:Panel Style="padding-top: 10px" ID="PanelLocation" runat="server" CssClass="row">
                                    <label class="col-sm-2 control-label">
                                        Location</label>
                                    <div class="col-sm-3 has-feedback">
                                        <asp:SqlDataSource ID="SqlDataSourceDivision" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString %>"
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSourceDistrict" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString %>"
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSourceThana" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString %>"
                                ...
                                <div class="row" style="padding-top: 10px">
                                    ...
                                    <div class="col-sm-5 has-feedback">
                                        <asp:TextBox ID="txtPCNo" Width="300px" CssClass="form-control" MaxLength="255" runat="server"
