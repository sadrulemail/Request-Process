...
namespace RequestProcess
{
    public partial class Email_Verify : System.Web.UI.Page
    {
                ...
                using (SqlConnection conn = new SqlConnection())
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(Query, conn))
                    {
                        ...
                        if (PageAccessType.ToUpper() == "INVALID")
                        {
                            ...
                            lnkErrorGo.NavigateUrl = "Default.aspx";
                            return;
                        }
        ...
        protected void cmdStartInsert_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(string.Format("Request_Master.aspx?email={0}&keycode={1}", Request.QueryString["email"], hidReturnKeycode.Value), true);
        }
    }
}