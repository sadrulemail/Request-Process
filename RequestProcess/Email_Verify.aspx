<%@ Page Title="" Language="C#" MasterPageFile="~/TrustBank.master" AutoEventWireup="true" Inherits="RequestProcess.Email_Verify" Codebehind="Email_Verify.aspx.cs" %>
                ...
                <asp:Panel ID="PanelEmailVarified" runat="server" Visible="false">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-left">
                            ...
                            <br />
                            <span class="courier">Please click next to proceed.</span>
                            <br />
                            <br />
                            <div class="col-md-3">
                                <asp:Button ID="cmdStartInsert" runat="server" CssClass="btn btn-success btn-block"
                                    Text="Next" OnClick="cmdStartInsert_Click" />
                            </div>
