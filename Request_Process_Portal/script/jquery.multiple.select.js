    ...
    MultipleSelect.prototype = {
        ...
        init: function () {
            ...
            if (this.options.filter) {
                this.$drop.append(
                    '<div class="ms-search">' +
                    '<input type="text" autocomplete="off" autocorrect="off" autocapitilize="off" spellcheck="false" placeholder="enter into to filter">' +
                    '</div>'
                );
            }
            var ul = $('<ul></ul>');
        ...
        filter: function () {
            ...
            if (text.length === 0) {
                ...
                this.$selectItems.each(function () {
                    ...
                    $parent[$parent.text().toLowerCase().indexOf(text) >= 0
//Value Search Added by: Ashik Iqbal
                    || $(this).val().toLowerCase() == text
                    || $(this).val().toLowerCase() * 1 == text * 1
                     ? 'show' : 'hide']();
                });
