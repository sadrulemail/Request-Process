<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="App_Users" CodeFile="App_Users.aspx.cs" %>

<%@ Register Src="TrustControl.ascx" TagName="TrustControl" TagPrefix="uc11" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <uc11:TrustControl ID="TrustControl1" runat="server" />
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="hidAppCode" runat="server" />
            <asp:TabContainer runat="server" ID="TabContainer1" CssClass="NewsTab" ActiveTabIndex="0"
                OnDemand="false">
                <asp:TabPanel runat="server" ID="tab1">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            PageSize="20" DataSourceID="SqlDataSourceUsers" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                <asp:HyperLinkField HeaderText="Emp ID" SortExpression="EmpID" DataTextField="EmpID"
                                    Target="_blank" DataNavigateUrlFormatString="../Profile.aspx?id={0}" DataNavigateUrlFields="EmpID">
                                ...
                                <asp:TemplateField HeaderText="On" SortExpression="LastInsert">
                                    <ItemTemplate>
                                        <div title='<%# Eval("LastInsert","{0:dddd \ndd, MMMM, yyyy \nh:mm:ss tt}") %>'>
                                            ...
                                            <time class="timeago" datetime='<%# Eval("LastInsert","{0:yyyy-MM-dd HH:mm:ss}") %>'></time>
                                        </div>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
