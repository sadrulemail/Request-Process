<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="iBanking_Req_Status_Count_Branch.aspx.cs" Inherits="iBanking_Req_Status_Count_Branch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    iBanking Service Request Browse Branch wise
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <asp:GridView ID="grdiBanking_Req_Status_Count" runat="server" DataKeyNames="ByBranchID"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Branch ID" SortExpression="ByBranchID">
                        <ItemTemplate>
                            <%# Eval("ByBranchID")%>
                        </ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSourceiBanking_Req_Status_Count" runat="server" ConnectionString="<%$ ConnectionStrings:Request_ProcessConnectionString %>"
                SelectCommand="s_iBanking_Req_Status_Count_Branch" SelectCommandType="StoredProcedure">
                <SelectParameters>
